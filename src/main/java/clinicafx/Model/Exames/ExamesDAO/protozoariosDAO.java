...
import clinicafx.Model.Exames.model_protozoarios;
...
public class protozoariosDAO {
    ...
    public protozoariosDAO(MainApp mainapp) {
        if (mainapp != null) {
            try {
    ...
    public model_protozoarios getProtozoariosID(int ID, MainApp mainapp) {
        db.open();
        model_protozoarios obj = new model_protozoarios(mainapp);
...
//                obj.setFoto(rs.getString("foto"));//10
            ...
            db.close();
            MsgErro.MessagemErroBD(ex, "getProtozoariosID");
            return null;
        } catch (Exception ex) {
            db.close();
            MsgErro.MessagemErroBD(ex, "getProtozoariosID");
    ...
    public List<model_protozoarios> getProtozoariosList(MainApp mainapp) {
        db.open();
        ArrayList<model_protozoarios> result = new ArrayList<>();
        try {
...
//                obj.setFoto(rs.getString("foto"));//10
            ...
            db.close();
            MsgErro.MessagemErroBD(ex, "getProtozoariosList");
            return result;
    ...
    public void creatProtozoarios(model_protozoarios obj) {
        db.open();
        try {
            stmt = conexao.prepareStatement("INSERT INTO clientes ( `ID_fezes`, `e_histolitica`, `e_coli`, `g_lamblia`, `outros`) VALUES(?,?,?,?,?,?,?,?,?,?);");
...
//            stmt.setString(10, obj.getFoto());
            ...
            db.close();
            MsgErro.MessagemErroBD(ex, "creatProtozoarios");
        } catch (Exception ex) {
            db.close();
            MsgErro.MessagemErroBD(ex, "creatProtozoarios");
    ...
    public void updateProtozoarios(model_protozoarios obj) {
        db.open();
        try {
...
//            stmt.setInt(10, obj.getID_cliente());
            ...
            db.close();
            MsgErro.MessagemErroBD(ex, "updateProtozoarios");
        } catch (Exception ex) {
            db.close();
            MsgErro.MessagemErroBD(ex, "updateProtozoarios");
    ...
    public void deleteProtozoarios(model_protozoarios obj) {
        db.open();
        try {
...
//            stmt.setInt(1, obj.getID_clinica());
            ...
            db.close();
            MsgErro.MessagemErroBD(ex, "deleteProtozoarios");
        } catch (Exception ex) {
            db.close();
            MsgErro.MessagemErroBD(ex, "deleteProtozoarios");
